...
<head>
  ...
  <title>Admin Khazbon | Data Yetsak</title>
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="yetsak.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Yetsak</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Data Yetsak</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card-body p-0">
              ...
              <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    ...
                    WHERE tbl_arsip.id_unit = tbl_unit.id_unit AND tbl_arsip.id_bon = tbl_bon.id_bon AND tbl_unit.nama_unit = 'Yetsak'
