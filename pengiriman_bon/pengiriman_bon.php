<?php
  ...
  if(isset($_GET['del'])){
	  $query=mysqli_query($connect,"DELETE from tbl_bon where id_bon = '".$_GET['id']."'");
      if($query){
				echo "<script>alert('Data telah dihapus..');window.location='pengiriman_bon.php';</script>";
			}
  }
  ...
  if(isset($_GET['hal']))
    {
    	if($_GET['hal'] == "edit")
    	{
	        ...
	        $tampil = mysqli_query($connect, "SELECT * FROM tbl_bon where id_bon='".$_GET['id']."'");
  ...
  if (isset($_POST['submit'])) {
    ...
    if(@$_GET['hal']=="edit"){
      ...
      $ubah = mysqli_query($connect, "UPDATE tbl_bon SET order_product = '$_POST[order_product]' where id_bon = '$_GET[id]' ");
			if($ubah)
			{
				echo "<script>
						alert('Ubah Data Sukses');
						window.location='pengiriman_bon.php';</script>";
			}else{
        echo "<script>
      ...
      $query=mysqli_query($connect,"INSERT INTO tbl_bon(order_product) VALUES('$order_product')");
        if($query){
          echo "<script>
          alert('Order product berhasil ditambahkan..');
          window.location='pengiriman_bon.php';</script>";
        }else{
          echo "<script>
          alert('Order product gagal ditambahkan..');
          window.location='pengiriman_bon.php';</script>";
        }
      }
    }
...
<head>
  ...
  <title>Admin Khazbon | Data Order Product</title>
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="pengiriman_bon.php" class="nav-link active">
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data Order Product</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item">Dashboard</li>
              <li class="breadcrumb-item">Data Order Product</li>
              <li class="breadcrumb-item active">Pecahan X</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="card card-primary">
            ...
            <form action="" method="POST">
              <div class="form-group">
                <label for="nama_unit">Order Product</label><br>
                <input type="number" id="order_product" name="order_product" value="<?=@$vorder_product?>" class="form-control" required>
              </div>
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body p-0">
              ...
              <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody id = "tampil">
                  <?php
					          $sql=mysqli_query($connect,"SELECT * FROM tbl_bon ORDER BY order_product ASC");
					          $cnt=1;
