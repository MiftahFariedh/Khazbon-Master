...
<head>
  ...
  <title>Admin Khazbon | Data Khazcutas</title>
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="khazcutas.php" class="nav-link  active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Khazcutas</p>
                </a>
              </li>
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data Khazcutas</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item">Dashboard</li>
              <li class="breadcrumb-item">Data Pecahan X</li>
              <li class="breadcrumb-item active">Data Khazcutas</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card-body p-0">
              ...
              <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php
                    ...
                    WHERE tbl_arsip.id_unit = tbl_unit.id_unit AND tbl_arsip.id_bon = tbl_bon.id_bon AND tbl_unit.nama_unit = 'Khazcutas'
