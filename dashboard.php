...
<head>
  ...
  <title>Admin Khazbon | Dashboard</title>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3>
                <?php
					        $sql=mysqli_query($connect, "SELECT SUM(jumlah) AS total FROM tbl_arsip 
                  INNER JOIN tbl_unit ON tbl_unit.id_unit = tbl_arsip.id_unit
                  INNER JOIN tbl_bon ON tbl_bon.id_bon = tbl_arsip.id_bon
                  WHERE tbl_arsip.id_unit = tbl_unit.id_unit AND tbl_arsip.id_bon = tbl_bon.id_bon AND tbl_unit.nama_unit = 'Cemor'");
              ...
              <a href="cemor/cemor.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
