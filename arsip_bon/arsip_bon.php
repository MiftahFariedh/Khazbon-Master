<?php
  ...
  if(isset($_GET['del'])){
    $sql=mysqli_query($connect,"SELECT * FROM tbl_arsip where id_arsip = '".$_GET['id']."'");
    $data=mysqli_fetch_array($sql);
    $foto=$data['gambar'];
    unlink("gallery/".$foto);
    $query=mysqli_query($connect,"DELETE from tbl_arsip where id_arsip = '".$_GET['id']."'");
      if($query){
				echo "<script>alert('Data telah dihapus..');window.location='arsip_bon.php';</script>";
			}
  }
?>
...
<head>
  ...
  <title>Admin Khazbon | Data Arsip Bon</title>
    ...
    <div class="sidebar">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="arsip_bon.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pecahan X</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Data Arsip Bon</li>
        ...
        <div class="col-md-12">
          <div class="card card-primary card-outline">
            ...
            <div class="card-body p-0">
              ...
              <a href="form_arsip_bon.php?&hal=tambahdata" class="btn btn-info mb-3">Tambah Data</a>
